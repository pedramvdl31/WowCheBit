...
<script type="text/javascript" src="/assets/js/invoices/edit.js"></script>
@stop
...
<div class="jumbotron">
   ...
   {!! Form::open(array('action' => 'InvoicesController@postEdit', 'class'=>'','role'=>"form")) !!}
		...
		<div id="customerInfo" class="steps panel panel-info hide">
			...
			<div class="panel-body">
				<div id="customerGuests" class="customerListDiv">
					<div class="form-group {!! $errors->has('firstname') ? 'has-error' : false !!}">
						<label class="control-label" for="firstname">First Name</label>
						{!! Form::text('firstname', $invoices->firstname, array('id'=>'firstName','class'=>'form-control', 'placeholder'=>'First Name')) !!}
					...
					<div class="form-group {!! $errors->has('lastname') ? 'has-error' : false !!}">
						...
						{!! Form::text('lastname', $invoices->lastname, array('id'=>'lastName','class'=>'form-control', 'placeholder'=>'Last Name')) !!}
					...
					<div class="form-group {!! $errors->has('naver_username') ? 'has-error' : false !!}">
						...
						{!! Form::text('naver_username', $invoices->naver_username, array('id'=>'naver-username','class'=>'form-control', 'placeholder'=>'Naver Username')) !!}
					...
					<div class="form-group {!! $errors->has('email') ? 'has-error' : false !!}">
						<label class="control-label" for="email">Email</label>
						{!! Form::text('email', $invoices->email, array('id'=>'email','class'=>'form-control', 'placeholder'=>'(ex: example@example.com)','status'=>false)) !!}
					...
					<div class="form-group {!! $errors->has('phone') ? 'has-error has-feedback' : false !!}">
						...
						{!! Form::text('phone', $invoices->phone, array('id'=>'phone','class'=>'form-control form-phone', 'placeholder'=>'eg ### ### ####')) !!}
					...
					<div class="form-group {!! $errors->has('street') ? 'has-error has-feedback' : false !!}">
						...
						{!! Form::text('street', $invoices->street, array('id'=>'street','class'=>'form-control','not_empty'=>'true', 'placeholder'=>'Street Address')) !!}
					...
					<div class="form-group {!! $errors->has('unit') ? 'has-error has-feedback' : false !!}">
						...
						{!! Form::text('unit', $invoices->unit, array('id'=>'unit','class'=>'form-control','not_empty'=>'true', 'placeholder'=>'Unit')) !!}
					...
					<div class="form-group {!! $errors->has('zipcode') ? 'has-error has-feedback' : false !!}">
						...
						{!! Form::text('zipcode', $invoices->zipcode, array('id'=>'zipcode','class'=>'form-control', 'not_empty'=>'true', 'placeholder'=>'Zipcode')) !!}
					...
					<div class="form-group {!! $errors->has('city') ? 'has-error has-feedback' : false !!}">
						...
						{!! Form::text('city', $invoices->city, array('id'=>'city','class'=>'form-control', 'not_empty'=>'true', 'placeholder'=>'City','data-provide'=>'typeahead', 'autocomplete'=>'off')) !!}
					...
					<div class="form-group {!! $errors->has('state') ? 'has-error has-feedback' : false !!}">
						...
						{!! Form::text('state', $invoices->state, array('id'=>'state','class'=>'form-control','not_empty'=>'true', 'placeholder'=>'State')) !!}
					...
					<div class="form-group {!! $errors->has('country') ? 'has-error has-feedback' : false !!}">
						...
						{!! Form::select('country', $country_code, $invoices->country, array('id'=>'country','class'=>'form-control','not_empty'=>'true')) !!}
			...
			<div class="panel-body">
				<div id="customerGuests" class="customerListDiv">
					...
					<div class="form-group {!! $errors->has('pretax') ? 'has-error has-feedback' : false !!}">
						...
						{!! Form::text('pretax', $invoices->pretax, array('id'=>'pretax','class'=>'form-control','not_empty'=>'true', 'placeholder'=>'Pretax')) !!}
					...
					<div class="form-group {!! $errors->has('tax') ? 'has-error has-feedback' : false !!}">
						...
						{!! Form::text('tax', $invoices->tax, array('id'=>'tax','class'=>'form-control','not_empty'=>'true', 'placeholder'=>'Tax')) !!}
					...
					<div class="form-group {!! $errors->has('aftertax') ? 'has-error has-feedback' : false !!}">
						...
						{!! Form::text('aftertax', $invoices->aftertax, array('id'=>'aftertax','class'=>'form-control','not_empty'=>'true', 'placeholder'=>'Aftertax')) !!}
					...
					<div class="form-group {!! $errors->has('quantity') ? 'has-error has-feedback' : false !!}">
						...
						{!! Form::text('quantity', $invoices->quantity, array('id'=>'quantity','class'=>'form-control','not_empty'=>'true', 'placeholder'=>'Quantity')) !!}
					...
					<div class="form-group {!! $errors->has('payment_id') ? 'has-error has-feedback' : false !!}">
						...
						{!! Form::text('payment_id', $invoices->payment_id, array('id'=>'payment_id','class'=>'form-control','not_empty'=>'true', 'placeholder'=>'Payment_id')) !!}
					...
					<div class="form-group {!! $errors->has('payment_type') ? 'has-error has-feedback' : false !!}">
						...
						{!! Form::select('payment_type', $payment_select, $invoices->payment_merchant, array('id'=>'payment_type','class'=>'form-control','not_empty'=>'true')) !!}
